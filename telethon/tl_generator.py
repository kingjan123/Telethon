...
class TLGenerator:
    ...
    def generate_tlobjects(scheme_file):
        ...
        for tlobject in tlobjects:
            ...
            with open(init_py, 'a', encoding='utf-8') as file:
                with SourceBuilder(file) as builder:
                    builder.writeln('from {} import {}'
                        .format(TLGenerator.get_full_file_name(tlobject),
            ...
            with open(filename, 'w', encoding='utf-8') as file:
                ...
                with SourceBuilder(file) as builder:
                    ...
                    builder.writeln()
                    builder.writeln()
                    builder.writeln('class {}(MTProtoRequest):'
        ...
        with open(filename, 'w', encoding='utf-8') as file:
            with SourceBuilder(file) as builder:
                ...
                for tlobject in tlobjects:
                    builder.writeln('{}: {}.{},'.format(hex(tlobject.id),
    ...
    def clean_and_generate():
        """Cleans and generates the TLObjects"""
...
if __name__ == '__main__':
    TLGenerator.clean_and_generate()
